...
namespace workspace23_8
{
    ...
    {
        public processing(string caption,DoWorkEventHandler doWork,object argument)
        {
            InitializeComponent();
            ...
            processLabel.Text = "initializing...";
            ...
            cancelButton.Click += new EventHandler(cancelAsyncButton_Click);
            backgroundWorker1.DoWork += doWork;
            backgroundWorker1.ProgressChanged += new ProgressChangedEventHandler(backgroundWorker1_ProgressChanged);
            backgroundWorker1.RunWorkerCompleted += new RunWorkerCompletedEventHandler(backgroundWorker1_RunWorkerCompleted);
        }
        public processing(string formTitle, DoWorkEventHandler doWorkHandler) : this(formTitle, doWorkHandler, null) { }
        ...
        private void backgroundWorker1_ProgressChanged(object sender, ProgressChangedEventArgs e)
        {
            ...
            processLabel.Text = (string)e.UserState;
        }
